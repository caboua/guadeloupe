# Villa CABOUA — guadeloupe

Site vitrine haut de gamme de la Villa CABOUA (Bouillante, Guadeloupe).

- **En ligne** : https://caboua.github.io/guadeloupe/
- Site statique : `index.html`, `css/style.css`, `js/main.js`, photos dans `images/`.
- Les **disponibilités** du calendrier de réservation sont lues depuis
  `https://caboua.github.io/Calendrier/data/reservations.json` (dépôt
